...
export const Dashboard: React.FC<DashboardProps> = ({ language }) => {
  ...
  const videoContent = {
    'For You': {
      featured: { title: "Hip Mobility Flow", duration: "12 min", level: "Beginner", img: "https://images.unsplash.com/photo-1574680096145-d05b474e2155?q=80&w=600&auto=format&fit=crop" },
      list: [
    ...
    'Mobility': {
      featured: { title: "Full Body Unlock", duration: "15 min", level: "All Levels", img: "https://images.unsplash.com/photo-1518611012118-696072aa579a?q=80&w=600&auto=format&fit=crop" },
      list: [
    ...
    'Strength': {
      featured: { title: "Core Foundations", duration: "20 min", level: "Intermediate", img: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=600&auto=format&fit=crop" },
      list: [
