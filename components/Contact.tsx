    ...
    <div className="pt-32 pb-20 min-h-screen animate-[fadeInUp_0.5s_ease-out_forwards]">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="max-w-3xl mb-16">
            <h1 className="text-5xl md:text-6xl font-semibold text-white tracking-tighter mb-6" dangerouslySetInnerHTML={{ __html: language === 'en' 
            ...
            <form className="space-y-4 animate-[fadeInUp_0.5s_ease-out_0.3s_forwards] opacity-0" onSubmit={(e) => { e.preventDefault(); alert('Application Submitted'); }}>
                <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        ...
                        <input type="text" className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-motion-accent transition-colors" placeholder="Jane" required />
                    </div>
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-motion-muted uppercase tracking-widest">{t.lname}</label>
                        <input type="text" className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-motion-accent transition-colors" placeholder="Doe" required />
                    </div>
                </div>

                <div className="space-y-2">
                    <label className="text-xs font-bold text-motion-muted uppercase tracking-widest">{t.email}</label>
                    <input type="email" className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-motion-accent transition-colors" placeholder="jane@example.com" required />
                </div>
                 ...
                 <div className="space-y-2">
                    ...
                    <textarea rows={5} className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-motion-accent transition-colors" placeholder={t.placeholderMsg} required></textarea>
                </div>

                <Button variant="primary" fullWidth className="mt-4 group">
