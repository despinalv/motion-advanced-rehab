    ...
    en: {
        ...
        team: [
            ...
            },
            {
                ...
                image: "https://images.unsplash.com/photo-1594824476960-e69059fa7563?q=80&w=800&auto=format&fit=crop",
    ...
    <section id="about" className="py-24 bg-motion-black border-t border-white/5 relative overflow-hidden">
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        <div className="max-w-3xl mb-16 reveal-on-scroll">
            <h2 className="text-4xl md:text-5xl font-semibold text-white tracking-tighter mb-6" dangerouslySetInnerHTML={{ __html: language === 'en' 
