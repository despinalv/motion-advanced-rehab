...
export const BlogPost: React.FC<BlogPostProps> = ({ postId, onNavigate, onBack, language }) => {
  ...
  const postsEn: Record<string, any> = {
    '1': {
      ...
      readTime: "6 min read",
      image: "https://images.unsplash.com/photo-1579758629938-03607ccdbaba?q=80&w=1600&auto=format&fit=crop",
      content: (
        <>
    ...
    '2': {
      ...
      readTime: "5 min read",
      image: "https://images.unsplash.com/photo-1544367563-12123d8965cd?q=80&w=1600&auto=format&fit=crop",
      content: (
        <>
            <p className="lead text-xl text-white font-light mb-8">
    ...
    '4': {
        ...
        category: "Education",
        readTime: "8 min read",
        image: "https://images.unsplash.com/photo-1559757175-0eb30cd8c063?q=80&w=1600&auto=format&fit=crop",
        content: (
            <>
                <p className="lead text-xl text-white font-light mb-8">
